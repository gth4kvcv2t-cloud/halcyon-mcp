...
const tools: ToolDef[] = [
  ...
  },
  {
    ...
    description: '搜索表情包。支持关键词：情绪词（开心/无语/震惊/生气/悲伤/怀疑/得意/赞/卖萌/疑惑/嘲讽/思考/发呆/焦虑/崩溃/严肃/无奈/色/自嘲/可怜/委屈/恐慌/尴尬/不屑/卧槽/离谱/装逼）、角色词（奶龙/猫meme/熊猫头/吉娃娃/陈赫/青蛙）。调用此工具后，必须在回复中粘贴返回的Markdown图片（![名称](URL)），不能只描述不贴图。',
    inputSchema: {
      type: 'object',
      properties: {
