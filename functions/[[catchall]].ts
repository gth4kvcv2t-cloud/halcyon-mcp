...
const tools: ToolDef[] = [
  ...
  },
  {
    ...
    description: '搜索表情包。\n- 情绪: 开心, 无语, 震惊, 生气, 悲伤, 怀疑, 得意, 赞, 卖萌, 疑惑, 嘲讽, 思考, 发呆, 焦虑, 崩溃, 严肃, 无奈, 色, 自嘲, 可怜, 委屈, 恐慌, 尴尬, 不屑\n- 卧槽, 牛逼, 离谱, 有病, 装逼, 憨, 酸, 流口水, 哭, 笑, 看穿, 机智, 懂王, 认真, 专注, 夸, 棒, 厉害, 认可, 惊讶, 吓到, 问号, 激动, 抓狂, 炸了, 不信, 审视, 难过, 愣住, 呆滞, 放空, 苦笑, 假装, 正经, 撒娇, 抽象, 求饶, 求放过\n- 角色: 奶龙, 猫meme, 熊猫头, 吉娃娃, 陈赫, 青蛙\n- 动作: 笑, 哭, 尖叫, 吐舌, 指, 斜眼看, 带墨镜, 扶眼镜, 捧腹, 憋着\n调用此工具后，必须在回复中粘贴返回的Markdown图片（![名称](URL)），不能只描述不贴图。',
    inputSchema: {
      type: 'object',
      properties: {
